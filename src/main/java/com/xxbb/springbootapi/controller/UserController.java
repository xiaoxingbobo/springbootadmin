...
public class UserController extends AuthApiController<User, UserQuery, UserUpdate, UserMapper> {
     ...
     */
    @PostMapping
    @PreAuthorize("hasAnyAuthority('sys:user:add','sys:all:all')")
     ...
     */
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('sys:user:delete','sys:all:all')")
     ...
     */
    @PutMapping
    @PreAuthorize("hasAnyAuthority('sys:user:update','sys:all:all')")
    ...
    @PreAuthorize("hasAnyAuthority('sys:user:select','sys:all:all')")
     ...
     */
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('sys:user:select','sys:all:all','sys:all:all')")
