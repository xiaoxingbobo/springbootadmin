...
public class ApiController<K extends Common, T extends BaseQuery<K, T>, V extends BaseUpdate<K, V, T>, E extends IWrapperMapper<K, T, V>> extends BaseController {
    ...
    @PostMapping
    @PreAuthorize("hasAnyAuthority('superAdmin','create')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('superAdmin','delete')")
    ...
    @PutMapping
    @PreAuthorize("hasAnyAuthority('superAdmin','update')")
    ...
    @PreAuthorize("hasAnyAuthority('superAdmin','searches')")
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('superAdmin','find')")
    ...
    @PreAuthorize("hasAnyAuthority('superAdmin','listLimit')")
    ...
    @PreAuthorize("hasAnyAuthority('superAdmin','listAll')")
    ...
    @PreAuthorize("hasAnyAuthority('superAdmin','pagedScreen')")
    ...
    @PreAuthorize("hasAnyAuthority('superAdmin','pagedList')")
    ...
    @PreAuthorize("hasAnyAuthority('superAdmin','pagedSearches')")
